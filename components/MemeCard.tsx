  ...
  return (
    <div className="group bg-gradient-to-br from-white via-white to-gray-50/80 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 hover:scale-[1.02] border border-white/30 backdrop-blur-sm relative">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-center text-sm text-gray-500 border-t border-gray-100 pt-3">
          <button
          ...
          >
            ...
            <svg className={`w-3 h-3 transition-transform duration-200 ${showAllShares ? 'rotate-180' : ''}`} fill="currentColor" viewBox="0 0 24 24">
